...
{
    /// <summary>
    /// Controls the status indicators (Play, Pause, Stop, and Red/Green Squares).
    /// </summary>
    public class StatusDisplay : MonoBehaviour, ISkinApplicator
    {
        public enum PocketAmpStatus
        {
            Stop,
            Loading,
            Playing,
