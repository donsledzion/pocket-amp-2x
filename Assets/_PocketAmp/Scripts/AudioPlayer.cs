...
namespace SoftAware.PocketAmp
{
    ...
    /// and delegates actual playback to an IPlaybackEngine and UI to a UIController.
    /// </summary>
    ...
    public class AudioPlayer : MonoBehaviour
    {
        ...
        private void PlayNextBackground()
        {
            ...
            if (nextSong.HasNativePath)
            {
                ...
                AndroidMediaBridge.UpdateMetadata(nextSong.Title, "PocketAmp", durationMs, 0, true);
            }
        }
        ...
        private void PlayPreviousBackground()
        {
            ...
            if (prevSong.HasNativePath)
            {
                ...
                AndroidMediaBridge.UpdateMetadata(prevSong.Title, "PocketAmp", durationMs, 0, true);
            }
        }
#endif
        ...
        private void UpdateNotification()
        {
            if (currentSong != null)
            {
                ...
                AndroidMediaBridge.UpdateMetadata(currentSong.Title, "PocketAmp", durationMs, positionMs, engine.IsPlaying);
            }
        }
