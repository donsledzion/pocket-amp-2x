...
namespace SoftAware
{
    ...
    public class TextSpriteProvider : MonoBehaviour
    {
        ...
        private void AutoLoadSpritesFromTexture()
        {
            ...
            var guids = UnityEditor.AssetDatabase.FindAssets("Text t:Texture2D", new[] { "Assets/_PocketAmp/Skins/Classic" });
            
            if (guids.Length == 0)
            {
                Debug.LogError("Text.png not found in Assets/_PocketAmp/Skins/Classic");
                return;
            }
